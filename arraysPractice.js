...
//Create a function named 'looper' that is given family as it's only argument, loops through the given array, and alerts every item in the array.
  ...
  var looper = (family) => family.map((member) => alert(member));
...
*/
  ...
  var removeItem = (myGroceryList, item) => {
    ...
    itemIndex >= 0 && myGroceryList.splice(itemIndex, 1);
...
var createUser = function(name, email, password, username) {
  return {
    name: name,
    email: email,
    password: password,
...
var user2 = createUser("Nick Hathaway", "nickhath@email.com", "password", "nickhath");
var user3 = createUser("Gary Hathaway", "garyhat@email.com", "2", "ghat");
